...
====================================
This guide will show you how to build bitcoinloved (headless client) for OSX.
...
5.  (Optional) You can also install bitcoinloved to your path:
...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure BitcoinLove with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the BitcoinLove wallet:
...
You have the choice to build the GUI BitcoinLove wallet as a Mac OSX app, described in “How to build the BitcoinLove-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the BitcoinLove-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find BitcoinLove-Qt.dmg inside your BitcoinLove folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/BitcoinLove/src/qt/bitcoinlove-qt