...
Run BitcoinLove behind a Tor proxy
----------------------------------
...
```
./bitcoinloved -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
Run a BitcoinLove hidden server
-------------------------------
...
HiddenServicePort 989 127.0.0.1:5771
...
your bitcoinloved's P2P listen port (5771 by default).
```
...
```
./bitcoinloved -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 5771 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./bitcoinloved -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known BitcoinLove Tor relays
------------------------------------
```
