...
In order to support loading of multiple wallets in bitcoinlove-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinlove.cpp.
...
Changes to bitcoinlove.cpp
----------------------
bitcoinlove.cpp is the entry point into bitcoinlove-qt, and as such, will require some minor modifications to provide hooks for
