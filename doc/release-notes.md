BitcoinLove Core version 3.0.4 is now available from:

  <https://github.com/bitcoinloveproject/bitcoinlove/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/bitcoinloveproject/bitcoinlove/issues>


Mandatory Update
==============

BitcoinLove Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zBLV protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/BitcoinLove-Qt (on Mac) or bitcoinloved/bitcoinlove-qt (on Linux).


Compatibility
==============

BitcoinLove Core is extensively tested on multiple operating systems using
...
BitcoinLove Core should also work on most other Unix-like systems but is not
...
- #327 `aa1235a` [Main] Don't limit zBLV spends from getting into the mempool (Fuzzbawls)
...
### GUI
- #309 `f560ffc` [UI] Better error message when too much inputs are used for spending zBLV (Mrs-X)
...
- #314 `f1c830a` Fix issue causing crash when bitcoinloved --help was invoked (Jon Spock)
- #326 `8b6a13e` Combine 2 LogPrintf statement to reduce debug.log clutter (Jon Spock)
- #328 `a6c18c8` [Main] BitcoinLove not responding on user quitting app (Aaron Langford)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/bitcoinlove-project-translations/).
