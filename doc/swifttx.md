...
* WebSocket: [https://github.com/bitcoinloveproject/insight-api-bitcoinlove#web-socket-api](https://github.com/bitcoinloveproject/insight-api-bitcoinlove#web-socket-api) 
* API: [https://github.com/bitcoinloveproject/insight-api-bitcoinlove#swifttx-transactions](https://github.com/bitcoinloveproject/insight-api-bitcoinlove#swifttx-transactions) 
...
By default, the BitcoinLove Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinLove Core daemon:
