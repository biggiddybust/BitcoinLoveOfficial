...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemabitcoinloveGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemabitcoinloveGrant grantOutbound;
