...
/** Utility functions used by the BitcoinLove Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinLove addresses in monospace font
...
// Parse "bitcoinlove:" URI into recipient object, return true on successful parsing
