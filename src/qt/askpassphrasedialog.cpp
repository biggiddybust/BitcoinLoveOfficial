                                                                                           ...
                                                                                           fCapsLock(false)
{
    ...
    ui->passEdit1->setMaxLength(MAX_PASSBLVASE_SIZE);
    ui->passEdit2->setMaxLength(MAX_PASSBLVASE_SIZE);
    ui->passEdit3->setMaxLength(MAX_PASSBLVASE_SIZE);
...
void AskPassphraseDialog::accept()
{
    ...
    if (!model)
        return;
    oldpass.reserve(MAX_PASSBLVASE_SIZE);
    newpass1.reserve(MAX_PASSBLVASE_SIZE);
    newpass2.reserve(MAX_PASSBLVASE_SIZE);
