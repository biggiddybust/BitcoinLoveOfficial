...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BLV);
    unitlist.append(mBLV);
    unitlist.append(uBLV);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BLV:
        return QString("bitcoinlove");
    case mBLV:
        return QString("mbitcoinlove");
    case uBLV:
        return QString::fromUtf8("ubitcoinlove");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BLV:
            return QString("tBLV");
        case mBLV:
            return QString("mtBLV");
        case uBLV:
            return QString::fromUtf8("μtBLV");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BLV:
            return QString("BLV");
        case mBLV:
            return QString("Milli-BLV (1 / 1" THIN_SP_UTF8 "000)");
        case uBLV:
            return QString("Micro-BLV (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BLV:
            return QString("TestBLVs");
        case mBLV:
            return QString("Milli-TestBLV (1 / 1" THIN_SP_UTF8 "000)");
        case uBLV:
            return QString("Micro-TestBLV (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
