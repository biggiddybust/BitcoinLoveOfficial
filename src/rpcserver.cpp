...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinLove features */
        {"bitcoinlove", "masternode", &masternode, true, true, false},
        {"bitcoinlove", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinlove", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinlove", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinlove", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinlove", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinlove", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinlove", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinlove", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinlove", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinlove", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinlove", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinlove", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinlove", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinlove", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinlove", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinlove", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinlove", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinlove", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinlove", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinlove", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinlove", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinlove", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinlove", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinlove", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinlove", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinlove", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinlove", "mnsync", &mnsync, true, true, false},
        {"bitcoinlove", "spork", &spork, true, true, false},
        {"bitcoinlove", "getpoolinfo", &getpoolinfo, true, true, false},
        {"bitcoinlove", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5772/\n";
}
