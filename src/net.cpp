...
static CSemabitcoinlove* semOutbound = NULL;
...
void CNode::copyStats(CNodeStats& stats)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (BitcoinLove users should be well used to small numbers with many decimal places by now :)
...
void static ProcessOneShot()
{
    ...
    CAddress addr;
    CSemabitcoinloveGrant grant(*semOutbound, true);
    if (grant) {
...
void ThreadOpenConnections()
{
    ...
    while (true) {
        ...
        CSemabitcoinloveGrant grant(*semOutbound);
        boost::this_thread::interruption_point();
...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemabitcoinloveGrant* grantOutbound, const char* pszDest, bool fOneShot)
{
    //
...
void StartNode(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    if (semOutbound == NULL) {
        // initialize semabitcoinlove
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, nMaxConnections);
        semOutbound = new CSemabitcoinlove(nMaxOutbound);
    }
