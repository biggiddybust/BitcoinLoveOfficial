...
/** 
    ...
    ****Note - for BitcoinLove we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of bitcoinlove coming in to a transaction
